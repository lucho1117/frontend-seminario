                    ...
                    <div className="col-12 md:col-6">
                        <div className="card card-w-title" onClick={directVenta}>
                            <div className="text-center">
                                <img height="600" src="assets/demo/images/ventaProducto.jpeg" className="w-9 shadow-2 my-3 mx-0" />
                    ...
                    <div className="col-12 md:col-6">
                        <div className="card card-w-title">
                            <div className="text-center" onClick={directAlquiler}>
                                <img height="600" src="assets/demo/images/alquiler.png" className="w-9 shadow-2 my-3 mx-0" />
